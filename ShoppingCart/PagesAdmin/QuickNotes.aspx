<%@ Page Title="Quick Notes" Language="C#" MasterPageFile="~/PagesAdmin/NestedAdmin.master" AutoEventWireup="true" CodeBehind="QuickNotes.aspx.cs" Inherits="ShoppingCart.QuickNotes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="adminContentPlaceHolder" runat="server">
    ...
    <ul>
        ...
        <li>To remove a cookie set its expiration to the past</li>
    </ul>
